...
export class Game {
    ...
    public stop() {
        ...
        this.socketGame.off(SockEvent.SE_GM_SEARCH, this.handleSearchGame.bind(this));
        this.socketGame.off(SockEvent.SE_GM_JOIN, this.handleJoinGame.bind(this));
        this.socketGame.off(SockEvent.SE_GM_FINISH, this.handleFinishGame.bind(this));
        this.socketMatchmaking.off(SockEvent.SE_MM_FOUND, this.handleQueue.bind(this));
    }
}